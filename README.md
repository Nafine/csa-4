...
|-------|-----------|------------------------------------------------------|
| 25    | halted    | 1 = остановка симуляции                              |
| 24    | acc_l     | 1 = замкнуть acc                                     |
| 23    | sp_l      | 1 = замкнуть sp                                      |
| 22    | ip_l      | 1 = замкнуть ip                                      |
| 21    | cr_l      | 1 = замкнуть cr                                      |
| 20    | ar_l      | 1 = замкнуть ar                                      |
| 19    | mem_w     | 1 = защелкнуть данные в память по адресу             |
| 18-17 | ar_sel    | 00 = ip, 01 = cr, 10 = ac                            |
| 16    | ip_sel    | 0 = alu, 1 = cu                                      |
